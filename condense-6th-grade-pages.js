#!/usr/bin/env node
/**
 * Condense 6th grade reading pages to 250-300 words/page
 * Accept some scrolling to reduce number of pages to click through
 */

const fs = require('fs');

const MAX_WORDS_PER_PAGE = 280;
...
console.log(`\n✅ Total: ${totalUpdated} files updated (~280 words/page)`);
