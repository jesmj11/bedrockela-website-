...
// ===== CONFIGURATION =====
const CONFIG = {
    mythology: 'Norse', // Norse, Greek, Roman, etc.
    startDay: 141,
    endDay: 160,
    startWeek: 29,
    gradeLevel: '5th',
    storyFolder: '/Users/mushu/Desktop/BedrockELA/5th Grade/norse',
    vocabFile: '/Users/mushu/Desktop/BedrockELA/5th Grade/norse/Norse_Mythology_Vocab.csv',
    informationalFile: './norse-informational-texts.json',
    questionsFile: './norse-comprehension-questions.json',
    informationalQuestionsFile: './norse-informational-questions.json',
    skillsFile: './norse-weekly-skills.json',
    outputFolder: './curriculum/grade5/norse'
};

// ===== LESSON PLAN =====
const lessonPlan = [
    // Week 29
    { day: 141, story: "In_the_Beginning_The_Norse_Creation", title: "In the Beginning: The Norse Creation" },
    ...
    <div class="lesson-page" id="page9" style="display: none;">
        ...
        <div class="informational-section">
            ...
            <div class="comparison-table" style="margin-top: 30px;">
                <h4 style="color: #2c5aa0; margin-bottom: 15px;">Norse Myth vs. Modern Science</h4>
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    <div style="background: #fff8e1; padding: 20px; border-radius: 8px; border-left: 4px solid #fbbf24;">
                        <h5 style="color: #f59e0b; margin-bottom: 10px;">📜 Norse Version</h5>
                        <ul style="margin-left: 20px; line-height: 1.8;">
                            ${infoText.comparison.norse.map(item => `<li>${item}</li>`).join('\n                            ')}
                        </ul>
                    </div>
