...
chapters.forEach((chapter, idx) => {
  ...
  const shortQ = chapterQuestions.questions[1];
            ...
            pages: [
                ...
                // Comprehension: Multiple Choice
                {
                    render: () => \`
                        <div class="lesson-page-card content-page">
                            ...
                            <p style="margin-bottom: 20px;">Question 1 of 2</p>
                            
                            <div style="margin: 30px 0;">
                                <div style="padding: 20px; background: #f9f9f9; border-radius: 12px; border-left: 4px solid #1B2A4A;">
                                    <p style="font-weight: 600; margin-bottom: 15px;">${mcQ.question.replace(/'/g, "\\'")}</p>
                                    ${mcQ.options.map((opt, oidx) => `
                                    <div style="margin: 12px 0;">
                                        <label style="display: flex; align-items: start; cursor: pointer; padding: 10px; border-radius: 8px; transition: background 0.2s;" onmouseover="this.style.background='#f0f0f0'" onmouseout="this.style.background='transparent'">
                                            <input type="radio" name="mc-q1" value="${oidx}" style="margin-right: 10px; margin-top: 4px;">
                ...
                // Comprehension: Short Answer
                {
                    render: () => \`
                        <div class="lesson-page-card content-page">
                            <h2>Reading Comprehension</h2>
                            <p style="margin-bottom: 20px;">Question 2 of 2</p>
                            
                            <div style="margin: 30px 0;">
                                <div style="padding: 20px; background: #f9f9f9; border-radius: 12px; border-left: 4px solid #1B2A4A;">
                                    <p style="font-weight: 600; margin-bottom: 12px;">${shortQ.question.replace(/'/g, "\\'")}</p>
                                    ${shortQ.hint ? `<p style="font-size: 14px; color: #666; font-style: italic; margin-bottom: 15px;">💡 Hint: ${shortQ.hint.replace(/'/g, "\\'")}</p>` : ''}
                                    <textarea 
                                      id="comp-short"
                                      style="width: 100%; min-height: 150px; padding: 10px; border: 2px solid #305853; border-radius: 8px; font-family: inherit; font-size: 16px; line-height: 1.6;"
...
console.log(`\n✅ Generated ${chapters.length} COMPLETE lessons!`);
console.log('Each lesson includes: Title + Objectives + Vocabulary (2) + Reading (4 pages) + Comprehension (2) + Completion');
