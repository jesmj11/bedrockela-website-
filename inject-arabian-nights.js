...
const generatedContent = JSON.parse(
  fs.readFileSync('generated-5th-grade-arabian-nights.json', 'utf8')
);

// Arabian Nights stories for Days 41-48 (skip 45 - assessment day)
const days = [41, 42, 43, 44, 46, 47, 48];
...
days.forEach(day => {
  ...
  // Pattern: <p style="margin-bottom: 12px; color: #444;">QUESTION HERE</p>
  let questionCount = 0;
  html = html.replace(
  ...
  // The pattern is more complex - need to find the div with reading-passage class
...
console.log('\n🎉 All Arabian Nights lessons updated!');
