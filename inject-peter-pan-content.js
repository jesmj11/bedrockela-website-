#!/usr/bin/env node
/**
 * Inject comprehensive content for Peter Pan into 3rd grade days 31-60
 */

const fs = require('fs');
const content = JSON.parse(fs.readFileSync('generated-3rd-grade-peter-pan.json', 'utf8'));
...
for (let day = 31; day <= 59; day++) {
  ...
  // 4. Update comprehension questions (3 questions)
  for (let q = 0; q < 3; q++) {
    const qNum = q + 1;
  ...
  // 5. Update journal reflection prompt
...
console.log(`\n✅ Injected Peter Pan content into ${updated} lessons!`);
