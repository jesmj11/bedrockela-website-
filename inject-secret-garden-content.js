#!/usr/bin/env node
/**
 * Inject comprehensive content for The Secret Garden into 3rd grade days 151-180
 */

const fs = require('fs');
const content = JSON.parse(fs.readFileSync('generated-3rd-grade-secret-garden.json', 'utf8'));

let updated = 0;

for (let day = 151; day <= 179; day++) {
...
console.log(`\n✅ Injected The Secret Garden content into ${updated} lessons!`);
