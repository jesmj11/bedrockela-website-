/**
 * Week 31 Mini-Lessons: review
 * Audio-only Billy scripts (student-led, replay on each line)
 * Days 1-5: various
 * Sight words: review
 */

class BillyWeek31Lesson extends BillyMiniLesson {
  ...
  getDay1Script() {
    ...
    return     [
          {
                "text": "Hi! Welcome to Week 31, Lesson 1. This is a mastery week!",
                "pause": 2000
          },
          {
  ...
  getDay2Script() {
    ...
    return     [
          {
                "text": "Hi! I'm Billy. Welcome to Week 31, Lesson 2. Let's learn together!",
                "pause": 2000
          },
          {
  ...
  getDay3Script() {
    ...
    return     [
          {
                "text": "Hi! I'm Billy. Welcome to Week 31, Lesson 3. Let's learn together!",
                "pause": 2000
          },
          {
                "text": "Let's warm up our reading voices. Are you ready?",
  ...
  getDay4Script() {
    ...
    return     [
          {
                "text": "Hi! I'm Billy. Welcome to Week 31, Lesson 4. Let's learn together!",
                "pause": 2000
          },
          {
                "text": "Let's warm up our reading voices. Are you ready?",
  ...
  getDay5Script() {
    ...
    return     [
          {
                "text": "Hi! I'm Billy. Welcome to Week 31, Lesson 5. Let's learn together!",
                "pause": 2000
          },
          {
                "text": "Let's warm up our reading voices. Are you ready?",
...
if (typeof document !== 'undefined') {
  document.addEventListener('DOMContentLoaded', () => {
    const container = document.querySelector('[data-billy-week="31"]');
    if (container) {
      const day = parseInt(container.getAttribute('data-billy-day') || '1');
      window.billyLesson = new BillyWeek31Lesson(day);
    }
  });
}
