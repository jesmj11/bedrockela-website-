#!/usr/bin/env node
/**
 * Re-paginate 6th grade books to 150 words/page (now that headers are removed)
 * Balance between fitting on screen and not too many pages to click through
 */
...
for (let day = 1; day <= 180; day++) {
  ...
  // Extract titles from first page only (which has headers)
                ...
                // Reading Page ${pageNum} of ${newPages.length}
                {
                    render: () => \`
                        <div class="lesson-page-card content-page">
                            ...
                            <div style="padding: 15px; background: #f9f9f9; border-radius: 12px; line-height: 1.5; font-size: 12px;" class="reading-passage">
                                ${pageContent}
                            </div>
...
console.log(`\n✅ Total: ${totalUpdated} files updated (150 words/page max)`);
